...
def validatetmp_max(lim_tmp_max, maxtemp):
...
def validatetmp_min(lim_tmp_min, mintemp):
...
def validatehumid_max(lim_hmd_max, maxhumid):
...
def validatehumid_min(lim_hmd_min, minhumid):
...
def querydb_and_write(lim_tmp_min, lim_tmp_max, lim_hmd_min, lim_hmd_max,
                      conn, csvname):
    # Setup database
    cur = conn.cursor()
